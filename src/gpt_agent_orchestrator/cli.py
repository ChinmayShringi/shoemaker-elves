...
Usage:
  Manual mode:  gpt-orch ~/projects/my-app
  GPT mode:     gpt-orch ~/projects/my-app --gpt -d "Build a REST API"
"""
...
Examples:
  ...
  gpt-orch ~/projects/my-app

  # GPT mode — GPT generates and manages tasks
  gpt-orch ~/projects/my-app --gpt -d "Build a todo app with auth"

  # Resume after interruption
  gpt-orch ~/projects/my-app --resume

  # Configuration commands
  gpt-orch init                    # Interactive setup
  gpt-orch config show             # Show current config
  gpt-orch config set planner.model gpt-4  # Set config value
        """,
    )
    ...
    def validate(self):
        ...
        if self.args.gpt:
            ...
            if not api_key:
                ...
                self.logger.info("Run 'gpt-orch init' to configure, or set environment variable")
                sys.exit(1)
...
def cmd_init():
    ...
    if storage_choice == "2":
        ...
        env_var = PROVIDER_API_KEY_ENV_VARS.get(provider, "GPT_ORCH_OPENAI_API_KEY")
    ...
    try:
        ...
        print("\nYou can now run: gpt-orch <project-dir>")
...
def main():
    ...
    if args.command == "config":
        if args.config_command == "show":
            ...
            print("Usage: gpt-orch config {show|set}")
            sys.exit(1)
        return
