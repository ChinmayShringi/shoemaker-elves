...
Usage:
  Manual mode:  chainsmith ~/projects/my-app
  GPT mode:     chainsmith ~/projects/my-app --gpt -d "Build a REST API"
"""
...
Examples:
  ...
  chainsmith ~/projects/my-app

  # GPT mode — GPT generates and manages tasks
  chainsmith ~/projects/my-app --gpt -d "Build a todo app with auth"

  # Resume after interruption
  chainsmith ~/projects/my-app --resume

  # Configuration commands
  chainsmith init                    # Interactive setup
  chainsmith config show             # Show current config
  chainsmith config set planner.model gpt-4  # Set config value
        """,
    )
    ...
    def validate(self):
        ...
        if self.args.gpt:
            ...
            if not api_key:
                ...
                self.logger.info("Run 'chainsmith init' to configure, or set environment variable")
                sys.exit(1)
...
def cmd_init():
    ...
    try:
        ...
        print("\nYou can now run: chainsmith <project-dir>")
...
def main():
    ...
    if args.command == "config":
        if args.config_command == "show":
            ...
            print("Usage: chainsmith config {show|set}")
            sys.exit(1)
        return
