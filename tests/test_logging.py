...
def test_logger_imports_without_rich():
    ...
    with patch.dict(sys.modules, {'rich': None, 'rich.console': None, 'rich.progress': None, 'rich.table': None, 'rich.panel': None, 'rich.text': None}):
        ...
        import importlib
        from gpt_agent_orchestrator import logging as log_module
...
def test_logger_basic_functions_without_rich():
    ...
    from gpt_agent_orchestrator.logging import Logger
...
def test_is_rich_available():
    ...
    from gpt_agent_orchestrator.logging import is_rich_available
...
def test_get_logger_singleton():
    ...
    from gpt_agent_orchestrator.logging import get_logger
...
def test_logger_table_with_rich(monkeypatch):
    ...
    from gpt_agent_orchestrator.logging import Logger, RICH_AVAILABLE
