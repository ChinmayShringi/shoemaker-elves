...
- `src/gpt_agent_orchestrator/tasks/1.md` - Update to realistic example
- `src/gpt_agent_orchestrator/tasks/2.md` - Update to realistic example
- `src/gpt_agent_orchestrator/tasks/3.md` - Update to realistic example

### Dependencies

- Must accurately reflect CLI implementation in `src/gpt_agent_orchestrator/cli.py`
- Must document all providers: openai, anthropic, azure_openai, deepseek, openai_compatible
- Must align with configuration system in `src/gpt_agent_orchestrator/config.py`
...
- `src/gpt_agent_orchestrator/tasks/1.md` — Updated, realistic Express setup
- `src/gpt_agent_orchestrator/tasks/2.md` — Updated, Prisma/PostgreSQL setup
- `src/gpt_agent_orchestrator/tasks/3.md` — Updated, JWT authentication
...
6. **CLI accuracy**: Verified all documented CLI commands match actual implementation by testing with `python -m gpt_agent_orchestrator --help`
