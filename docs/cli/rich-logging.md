...
### Plan
1. Add `rich` as an optional dependency (extra: `gpt-orch[rich]`)
...
- `src/gpt_agent_orchestrator/logging.py` (new) — logging module with rich support
- `src/gpt_agent_orchestrator/cli.py` — integrate rich logging
...
2. **Logging Module** (`src/gpt_agent_orchestrator/logging.py`):
...
- `src/gpt_agent_orchestrator/logging.py` (new) — Complete logging module with rich support
- `src/gpt_agent_orchestrator/cli.py` — Integrated logger throughout CLI
