...
"""
PyInstaller spec file for building shoemaker-elves standalone binary.
...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "shoemaker-elves.planners.openai_adapter",
        "shoemaker-elves.planners.anthropic_adapter",
        "shoemaker-elves.planners.azure_openai_adapter",
